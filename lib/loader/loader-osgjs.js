...
loader_osgjs.load = Promise.coroutine(function* (gResmgr, url, urlbin, callback) {
...
loader_osgjs.parse = Promise.coroutine(function* (test) {
    ...
    return loader_osgjs.parseNodeWithHierachy(rootNode['osg.Node']);
});
