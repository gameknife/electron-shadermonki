...
loader_osgjs.parseVbo = Promise.coroutine(function* (node, userDataNode, targetIbo ) {
            ...
            if (nodeData["File"] === "model_file.bin.gz") {
                ...
                for( let i=0; i < size; ++i)
                {
                    if(bbl_target !== null)
                    {
                        ...
                        targetArray.push( bbl_target[0] + i32[i * 3 + 0] * h_target[0] );
                        targetArray.push( bbl_target[1] + i32[i * 3 + 1] * h_target[1] );
                        targetArray.push( bbl_target[2] + i32[i * 3 + 2] * h_target[2] );
                    }
                    else
                    {
                        targetArray.push( i32[i * 3 + 0]);
                        targetArray.push( i32[i * 3 + 1]);
                        targetArray.push( i32[i * 3 + 2]);
                    }
                }
    ...
    {
        vbo.push( position[i * 3 + 0] * 0.00001 );
        vbo.push( position[i * 3 + 1] * 0.00001 );
        vbo.push( position[i * 3 + 2] * 0.00001 );
