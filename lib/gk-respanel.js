...
respanel.rescan_resources = function () {
    ...
    filelist.forEach( item => {
        ...
        let token = path.normalize( relpath + '/' + filename );
...
respanel.create_res_showobj = function(depth, filetoken, type) {
    ...
    // create name text
    var log_text = document.createTextNode(' ' + filetoken.split('/').pop());
