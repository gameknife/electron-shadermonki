...
const loader_osgjs = require('./loader/loader-osgjs');
        ...
        switch (ext)
        {
            ...
            case 'osgjs':
                ...
                loader_osgjs.load( this.filetoken, this.filetoken + '.bin',function(res) {
                    ref.glmeshobject = glw.createMeshObject(res[3].vbo, res[3].ibo, [glw.VERTEX_LAYOUT_P, glw.VERTEX_LAYOUT_T0, glw.VERTEX_LAYOUT_N]);
                    let timeelapsed = Date.now() - timestamp;
                    logger.info('Mesh ' + ref.filetoken + ' loaded in ' + timeelapsed + 'ms.');
                } );
