            ...
            case 'osgjs':
                ...
                loader_osgjs.load( this.filetoken, this.filetoken + '.bin',function(res) {
                    ...
                    res.forEach( item => {
                        ...
                        {
                            let textoken = path.join( path.dirname(ref.filetoken), item.mainMaterial.mainTexPath );
                        ...
                        {
                            let textoken = path.join( path.dirname(ref.filetoken), item.mainMaterial.lightMapTexPath );
                            let texres = gResmgr.get_res(textoken);
