            ...
            case 'osgjs':
                ...
                loader_osgjs.load( this.filetoken, this.filetoken + '.bin',function(res) {
                    ...
                    res.forEach( item => {
                        ...
                        //let worldMatrix = math.mat4.clone( item.worldmatrix );
                        //math.mat4.getTranslation(math.vec3.create(), worldMatrix);
                        //math.mat4.getRotation(math.quat.create(), worldMatrix);
                        //math.mat4.getscal


                        //submeshGO.transform.rotation = math.quat.identity( math.quat.create() );
