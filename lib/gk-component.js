...
class Transform extends Component {
    ...
    get localToWorldMatrix() {
        if(this._dirty)
        {
            ...
            //let negpos = math.vec3.negate( math.vec3.create(), this._position );
            //let childmatrix = math.mat4.fromRotationTranslationScaleOrigin(math.mat4.create(), this._rotation, this._position, this._scale, negpos );
